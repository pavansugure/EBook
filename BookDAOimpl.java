...
public class BookDAOimpl implements BookDAO {
	...
	public boolean updateEditBooks(BookDtls b) {
		boolean f = false;
		try {
			String sql = "update book_dtls set book_name=?, author=?, price=?, status=? where bookId=?";
	...
	public boolean addBooks(BookDtls b) {
		...
		try {
			String sql = "insert into book_dtls(book_name, author, price, bookCategory, status, photo, email) values(?,?,?,?,?,?,?)";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setString(1, b.getBookName());
			ps.setString(2, b.getAuthor());
			ps.setString(3, b.getPrice());
	...
	public List<BookDtls> getBookBySearch(String ch) {
		...
		try {
			...
			String sql = "select * from book_dtls where book_name like ? or author like ? or bookCategory like ? and status=? ";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setString(1, "%"+ch+"%");
			ps.setString(2, "%"+ch+"%");
			ps.setString(3, "%"+ch+"%");
